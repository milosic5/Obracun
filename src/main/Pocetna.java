...
public class Pocetna extends javax.swing.JFrame {
    ...
    public void updateData() {
        if (godinaComboBox.getSelectedIndex() >= 0) {
            System.out.println(godinaComboBox.getSelectedItem().toString());
            int godina = Integer.parseInt(godinaComboBox.getSelectedItem().toString());
            prihodiDialog.setGodina(godina);
            rashodiDialog.setGodina(godina);
            realizovaniPrihodi = CentralPoint.getInstance().getProjectDao().vratiRealizovanePrihode(godina);
            realizovaniRashodi = CentralPoint.getInstance().getProjectDao().vratiRealizovaneRashode(godina);
            if (godina == 2018) {
                ocekivaniPrihodi = 12 * 85000;
            } else {
                ocekivaniPrihodi = 12 * 95000;
            }
            ocekivaniRashodi = CentralPoint.getInstance().getProjectDao().vratiOcekivaneRashode(godina);
            prosecnaPlata = CentralPoint.getInstance().getProjectDao().vratiProsecnuPlatu(godina);
    ...
    public void updateYears() {
        ...
        godinaComboBox.addItem("2018");
        godinaComboBox.addItem("2019");
        godinaComboBox.addItem("2020");
        godinaComboBox.setSelectedIndex(1);
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("OBRAČUN ZARADA I TROŠKOVA");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(godinaComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(106, 106, 106)
